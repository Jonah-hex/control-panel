...
export default function NewBuildingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-[44px]">
          ...
          <div className="relative">
            ...
            <div ref={stepsContainerRef} className="flex items-center justify-between relative z-10">
              {steps.map((step) => (
                ...
                >
                  <div className={`w-10 h-10 md:w-12 md:h-12 rounded-2xl flex items-center justify-center mb-3 transition-transform duration-300 ${

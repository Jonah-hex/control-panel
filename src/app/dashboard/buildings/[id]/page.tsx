...
export default function BuildingDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" dir="rtl" style={{ fontFamily: '"Tajawal", "Cairo", "Noto Kufi Arabic", sans-serif' }}>
      {/* Animated Background */}
      <div className="fixed inset-0 bg-gradient-to-br from-indigo-600/20 via-purple-600/20 to-pink-600/20 animate-pulse"></div>
      <div className="fixed inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-purple-600/10 via-pink-600/10 to-red-600/10 animate-gradient-y"></div>
      </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between py-6">
              <div className="flex items-center gap-6">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-105"></div>
                  <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 transition-all duration-300 group-hover:bg-white/20">
                ...
                <div className="flex items-center gap-5">
                  <div className="relative">
                    <div className="absolute -inset-1 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl animate-pulse opacity-75"></div>
                    <div className="relative bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-xl border-2 border-white/30 rounded-3xl p-4">
                      <Building2 className="w-8 h-8 text-white" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
                    <h1 className="text-4xl font-black bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent leading-tight">
                      {building.name}
                    </h1>
                    <p className="text-sm font-medium text-white/80">رقم القطعة: {building.plot_number}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                {!isEditing ? (
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-teal-600 transition-all duration-300 transform translate-y-full group-hover:translate-y-0"></div>
                    <div className="relative bg-white border-2 border-emerald-500/30 px-6 py-3 rounded-2xl transition-all duration-300 group-hover:border-emerald-500/60 group-hover:shadow-lg group-hover:shadow-emerald-500/25 flex items-center gap-3">
                      <Edit2 className="w-5 h-5 text-emerald-600" />
                      <span className="font-bold text-emerald-600">تعديل البيانات</span>
                    </div>
                  </button>
                ) : (
                  <>
                    <button
                      onClick={handleSave}
                      disabled={isSaving}
                      className="group relative overflow-hidden mr-3"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 transition-all duration-300 transform translate-y-full group-hover:translate-y-0"></div>
                      <div className="relative bg-white border-2 border-blue-500/30 px-6 py-3 rounded-2xl transition-all duration-300 group-hover:border-blue-500/60 group-hover:shadow-lg group-hover:shadow-blue-500/25 flex items-center gap-3 disabled:opacity-60">
                        <Save className="w-5 h-5 text-blue-600" />
                        <span className="font-bold text-blue-600">{isSaving ? 'جاري الحفظ...' : 'حفظ'}</span>
                      </div>
                    </button>
                    <button
                      onClick={() => {
                      ...
                      className="group relative overflow-hidden"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-gray-600 to-gray-700 transition-all duration-300 transform translate-y-full group-hover:translate-y-0"></div>
                      <div className="relative bg-white border-2 border-gray-500/30 px-6 py-3 rounded-2xl transition-all duration-300 group-hover:border-gray-500/60 group-hover:shadow-lg group-hover:shadow-gray-500/25 flex items-center gap-3">
                        <X className="w-5 h-5 text-gray-600" />
                        <span className="font-bold text-gray-600">إلغاء</span>
                      </div>
                    </button>
                  </>
                )}
